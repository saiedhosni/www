<header class="row expanded collapse align-justify">
    ...
    <div class="row collapse align-middle">
      ...
      <div class="column">
        <nav>
          ...
          <ul class="menu">
            <li><a href="<?php echo LANGUAGE == 'fr' ? '/le-studio' : '/en/the-studio'; ?>" data-dot="contrast" class="need-highlight">Studio</a></li>
            <li><a href="<?php echo LANGUAGE == 'fr' ? '/nos-services' : '/en/our-services'; ?>" class="need-highlight">Services</a></li>
            <li><a href="<?php echo LANGUAGE == 'fr' ? '/contact' : '/en/contact'; ?>" data-dot="contrast" class="need-highlight">Contact</a></li>
          </ul>
        </nav>
      </div>
    </div>
  ...
  <div class="column shrink hide-for-small-only">
    <ul class="lang">
      <li class="<?php echo LANGUAGE == 'fr' ? 'active' : ''; ?>"><a href="/" class="need-highlight <?php echo LANGUAGE == 'fr' ? '' : 'no-barba'; ?>">Fr</a></li>
      <li class="<?php echo LANGUAGE == 'en' ? 'active' : ''; ?>"><a href="/en" class="need-highlight <?php echo LANGUAGE == 'en' ? '' : 'no-barba'; ?>">En</a></li>
    </ul>
  </div>
</header>
  ...
  <div class="menu mobile">
    ...
    <ul>
      ...
      <li class="<?php echo NAME == 'index' ? 'active' : ''; ?>" data-target="index">
        ...
        <ul class="social">
          <li><a href="https://www.facebook.com/studiomotio" target="_blank" rel="noopener" aria-label="Facebook"><svg><use xlink:href="/picture/sprite.svg#logo-facebook" /></svg></a></li>
          <li><a href="https://www.twitter.com/studiomotio" target="_blank" rel="noopener" aria-label="Twitter"><svg><use xlink:href="/picture/sprite.svg#logo-twitter" /></svg></a></li>
          <li><a href="https://www.instagram.com/studiomotio" target="_blank" rel="noopener" aria-label="Instagram"><svg><use xlink:href="/picture/sprite.svg#logo-instagram" /></svg></a></li>
        </ul>
      </li>
    </ul>
  </div>
