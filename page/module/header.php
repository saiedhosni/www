<header class="row expanded collapse align-justify">
  <div class="column shrink">
    <div class="row collapse align-middle">
      <div class="column">
        <a href="<?php echo LANGUAGE == 'fr' ? '/' : '/en'; ?>" class="logo need-highlight">
  ...
  <div class="menu mobile">
    ...
    <ul>
      ...
      <li class="<?php echo NAME == 'index' ? 'active' : ''; ?>" data-target="index">
        ...
        <ul class="social">
          <li><a href="https://www.facebook.com/studiomotio" target="_blank" rel="noopener"><svg><use xlink:href="/picture/sprite.svg#logo-facebook" /></svg></a></li>
          <li><a href="https://www.twitter.com/studiomotio" target="_blank" rel="noopener"><svg><use xlink:href="/picture/sprite.svg#logo-twitter" /></svg></a></li>
          <li><a href="https://www.instagram.com/studiomotio" target="_blank" rel="noopener"><svg><use xlink:href="/picture/sprite.svg#logo-instagram" /></svg></a></li>
        </ul>
      </li>
    </ul>
  </div>
