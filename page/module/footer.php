	...
	<div class="column">
		<div class="row align-center">
			<div class="column small-12 medium-5 medium-offset-0 large-4 large-offset-2">
				...
				<?php echo LANGUAGE == 'fr' ? '<a href="/contact" class="underline button big" data-dot="contrast"><span class="arrow"></span>Briefez-nous !</a>' : '<a href="/en/contact" class="underline button big" data-dot="contrast"><span class="arrow"></span>Brief-us!</a>'; ?>
			</div>
